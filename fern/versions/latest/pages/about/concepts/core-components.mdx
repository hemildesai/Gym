...
description: ""
---
> New to reinforcement learning for LLMs? Start with [Training](/latest/about/concepts/training) for context on SFT, RL, and RLVR, or refer to [Key Terminology](/latest/about/concepts/key-terminology) for a quick glossary.
