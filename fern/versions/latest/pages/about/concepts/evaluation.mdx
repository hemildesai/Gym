---
title: "Evaluation"
description: "How environments power model and agent evaluation."
position: 1.6
---

**Goal**: Understand model eval vs. agent eval, and what makes a good eval.
...
The results from evaluation inform how to improve your model or agent. See [Agent Harness Optimization](/latest/about/concepts/agent-harness-optimization) and [Training](/latest/about/concepts/training) for conceptual overviews.
