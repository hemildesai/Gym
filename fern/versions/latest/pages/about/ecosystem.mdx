...
Seamlessly combine environments and benchmarks from other libraries alongside NeMo Gym environments. See the [README](https://github.com/NVIDIA-NeMo/Gym?tab=readme-ov-file#-available-environments) for the full list. Here are a few examples:
...
Popular agent harnesses are available out of the box for evaluation and training. Some examples:
...
| [NeMo Safe Synthesizer](https://github.com/NVIDIA-NeMo/Safe-Synthesizer) | Generate privacy-safe synthetic copies of sensitive tabular datasets |
| [NeMo Anonymizer](https://github.com/NVIDIA-NeMo/Anonymizer) | Detect and replace PII in text data |
...
| [NeMo Guardrails](https://github.com/NVIDIA-NeMo/Guardrails) | Programmable safety guardrails for LLM systems |
